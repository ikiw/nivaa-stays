...
const ITIN_QUERY = {
  ...
  // 2026 catalog expansion — south food, White Town heritage, couples/solo, Auroville units
  'Jallikattu Restaurant':       'Jallikattu Restaurant, Ariyankuppam, Pondicherry',
  'Le Pondy':                    'Le Pondy, Nallavadu, Pondicherry',
  'Finz - Seafood & Barbeque':   'Finz Seafood and Barbeque, Club Mahindra, Pillayarkuppam, Pondicherry',
  'Aayi Mandapam':               'Aayi Mandapam, Bharathi Park, Pondicherry',
  'Our Lady of Angels Church':   'Notre Dame des Anges, Rue Dumas, Pondicherry',
  'Immaculate Conception Cathedral': 'Our Lady of the Immaculate Conception Cathedral, Mission Street, Pondicherry',
  'Old Lighthouse':              'Old Lighthouse, Goubert Avenue, Pondicherry',
  'Bay of Buddha':               'Bay of Buddha, The Promenade Hotel, Pondicherry',
  'Le Dupleix':                  'Le Dupleix, Caserne Street, White Town, Pondicherry',
  'Aurodhan Art Gallery':        'Aurodhan Art Gallery, Francois Martin Street, Pondicherry',
  'Cluny Embroidery Centre':     'Cluny Embroidery Centre, Romain Rolland Street, Pondicherry',
  'Romain Rolland Library':      'Romain Rolland Library, Pondicherry',
  'Upasana Design Studio':       'Upasana, Auroshilpam, Auroville',
  'Puducherry Science Centre & Planetarium': 'Dr A.P.J. Abdul Kalam Puducherry Science Centre and Planetarium, Lawspet, Puducherry',
  'Jawahar Toy Museum':          'Jawahar Toy Museum, Goubert Avenue, Pondicherry',
  'Pogo Land':                   'Pogo Land Sampoorna Amusement Park, Vazhudavoor Road, Pondicherry',
  'Pondy Ocean Park':            'Pondy Ocean Park, Pondicherry',
  'Savitri Bhavan':              'Savitri Bhavan, Auroville',
  'Auroville Visitor Centre':    'Auroville Visitor Centre',
  'Sadhana Forest':              'Sadhana Forest, Auroville',
  'Bharat Nivas (Auroville)':    'Bharat Nivas, Auroville',
  'Kallialay Surf School':       'Kallialay Surf School, Serenity Beach, Pondicherry',
  "L'Aqua":                      "L'Aqua, Ajanta Sea View Hotel, Beach Road, Pondicherry",
  'Le Café':                     'Le Cafe, Goubert Avenue, Pondicherry',
  // start areas
