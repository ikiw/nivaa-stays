  ...
  return (
    <Box sx={{ height: '100dvh', display: 'flex', flexDirection: 'column', gap: 1.25, p: 1.25, overflow: 'hidden', bgcolor: 'background.default' }}>
      ...
      <Paper elevation={0} sx={{ flexShrink: 0, borderRadius: 0, border: 'none',
        bgcolor: 'transparent' }}>
        <Box sx={{ width: '100%', maxWidth: showDesktopLanding ? 1300 : 'none', mx: 'auto', display: 'flex', alignItems: 'center', gap: 2, px: 0.75, py: 0.75, '@media (min-width: 1660px)': { maxWidth: showDesktopLanding ? 1680 : 'none' } }}>
      ...
      {showDesktopLanding ? (
        <Box sx={{ flex: 1, minHeight: 0, width: '100%', maxWidth: 1300, mx: 'auto', '@media (min-width: 1660px)': { maxWidth: 1680 } }}>
