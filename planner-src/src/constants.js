...
export const CAT_ICON = { Beach: BeachAccessRounded, Attraction: AccountBalanceRounded, Food: RestaurantRounded, Social: LocalBarRounded, Shopping: ShoppingBagRounded, Stay: FlagRounded, Area: FlagRounded };
/** Per-category colours, shared by the map markers, the picker icons and the day dots. */
export const CAT_HEX = { Stay: '#F59E0B', Area: '#F59E0B', Beach: '#38BDF8', Attraction: '#2DD4BF', Food: '#FB923C', Social: '#F472B6', Shopping: '#A78BFA' };
/** Distinct colour per route leg (start→1, 1→2, …) — cycles if there are more legs. */
export const LEG_COLORS = ['#2563EB', '#EA580C', '#059669', '#DB2777', '#7C3AED', '#D97706', '#0891B2', '#DC2626', '#65A30D', '#0D9488'];
...
export const CAT_LABEL = { Beach: 'Beaches', Attraction: 'Things to See', Food: 'Food & Drink', Social: 'Bars & Nightlife', Shopping: 'Shopping' };
/** Order the picker shows its category sections in. */
export const PICK_ORDER = ['Beach', 'Attraction', 'Food', 'Social', 'Shopping'];
...
export const DUR_SUB = { spiritual: [20, 30, 50], nature: [60, 90, 180], heritage: [30, 45, 90], adventure: [150, 180, 300] };
/** Food sub-type → [min, ideal, max] minutes. */
export const DUR_FOOD = { 'south-indian': [30, 45, 75], 'north-indian': [30, 45, 75], multicuisine: [35, 50, 90], cafe: [30, 40, 70], continental: [40, 60, 100], fine: [60, 90, 150], dessert: [15, 25, 45], asian: [30, 40, 70] };
/** Category (non Food/Attraction) → [min, ideal, max] minutes. */
export const DUR_CAT = { Beach: [45, 75, 160], Social: [60, 105, 210], Shopping: [30, 50, 100], Stay: [0, 0, 0], Area: [0, 0, 0] };
/** Specific places that differ from their type's default duration. */
export const DUR_OVERRIDE = {
...
export const BREAK_DUR = [30, 60, 240];
/** A meal stop without a fixed place ("Lunch nearby"). */
export const MEAL_DUR = [40, 55, 80];
/** Meal tokens usable in a curated plan. */
export const MEAL_LABELS = ['Breakfast', 'Lunch', 'Snack', 'Dinner'];
/** Timeline role tag → colour. */
export const TAG_COLOR = { Breakfast: '#F59E0B', Lunch: '#FB923C', Snack: '#FBBF24', Dinner: '#F472B6', 'Dinner & drinks': '#F472B6', Drinks: '#A78BFA', Shopping: '#A78BFA' };
/** Stay-duration options (minutes) offered per stop. */
export const STAY_OPTIONS = [15, 30, 45, 60, 75, 90, 105, 120, 150, 180, 210, 240];
/** Route colour per trip day (Day 1 blue, Day 2 orange). */
export const DAY_COLORS = ['#2563EB', '#EA580C'];
